...
import static com.web.core.constants.FrameworkConstants.YES;
...
public final class ExtentLogger {
	...
	public static void pass(String message, boolean isScreeshotNeeded) throws IOException {
	...
	public static void pass(Markup message, boolean isScreeshotNeeded) throws IOException {
		// if
	...
	public static void fail(String message, boolean isScreeshotNeeded) throws IOException {
		// if
	...
	public static void fail(Markup message, boolean isScreeshotNeeded) throws IOException {
		// if
		// (PropertyUtils.get(ConfigProperties.FAILED_STEPS_SCREENSHOT).equalsIgnoreCase("yes")
		// && isScreeshotNeeded) {
		if (ConfigLoader.getInstance().getFailedStepsScreenshot().equalsIgnoreCase(YES)
	...
	public static void skip(String message, boolean isScreeshotNeeded) throws IOException {
		// if
	...
	public static void skip(Markup message, boolean isScreeshotNeeded) throws IOException {
		// if
		// (PropertyUtils.get(ConfigProperties.SKIPPED_STEPS_SCREENSHOT).equalsIgnoreCase("yes")
		// && isScreeshotNeeded) {
		if (ConfigLoader.getInstance().getSkippedStepsScreenshot().equalsIgnoreCase(YES)){
